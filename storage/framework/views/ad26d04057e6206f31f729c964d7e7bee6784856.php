              ...
              <div class="row">
                <div class="col-xs-7">
                  ...
                  <div class="box-header with-border">
                    ...
                    <?php if($status == 1): ?>
                      <?php echo $__env->make('backend.home.participant._payment-status-approved', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <?php elseif($status == 2): ?>
                      <?php echo $__env->make('backend.home.participant._payment-status-pending', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <?php elseif($status == 3): ?>
                      <?php echo $__env->make('backend.home.participant._payment-status-cancel', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <?php endif; ?>
