<div class="row">
	<div class="col-xs-11">
		<ul class="nav nav-pills nav-justified thumbnail setup-panel">
			<li class="<?php echo e(Request::is('backend/home/speakerPage') ? 'active' : 'disabled'); ?>">
			<a>
			...
			<li class="<?php echo e(Request::is('backend/home/abstractApprove') || Request::is('backend/home/speakerPayment')? 'active' : 'disabled'); ?>">
			<a>
			...
			<li class="<?php echo e(Request::is('backend/home/uploadPaper')  || Request::is('backend/home/uploadPaperForm') ? 'active' : 'disabled'); ?>">
			<a>
			...
			<li class="<?php echo e(Request::is('backend/home/uploadRevisedPaper') ? 'active' : 'disabled'); ?>">
			<a>
			...
			<li class="<?php echo e(Request::is('backend/home/myTicketSpeaker') ? 'active' : 'disabled'); ?>">
			<a>
